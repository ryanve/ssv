...
assert.strictEqual(api.at("", 5), "")
assert.strictEqual(api.at("", -1), "")
assert.strictEqual(api.at("tom", NaN), "")
assert.strictEqual(api.at("tom", 1/0), "")
assert.strictEqual(api.at("tom", -1/0), "")
assert.strictEqual(api.at("tom", "0"), "tom")
assert.strictEqual(api.at("scott travis", "1"), "travis")
assert.strictEqual(api.at("scott travis", "-1"), "travis")
assert.strictEqual(api.at("mark tom scott", 0), "mark")
assert.strictEqual(api.at("mark tom scott", 2), "scott")
assert.strictEqual(api.at("mark tom scott", -1), "scott")
assert.strictEqual(api.at("mark tom scott", -2), "tom")
assert.strictEqual(api.at("mark tom scott", 1), "tom")
...
assert.strictEqual(api.need("", ""), "")
assert.strictEqual(api.need("", "tom"), "tom")
assert.strictEqual(api.need("tom tom", ""), "tom tom")
assert.strictEqual(api.need("mark tom", "mark"), "mark tom")
assert.strictEqual(api.need("mark tom", "mark mark"), "mark tom")
assert.strictEqual(api.need("mark tom", "travis"), "mark tom travis")
assert.strictEqual(api.need("mark tom travis", "travis"), "mark tom travis")
assert.strictEqual(api.need("mark tom", "travis travis"), "mark tom travis travis")
assert.strictEqual(api.need("mark tom tom", "travis"), "mark tom tom travis")
assert.strictEqual(api.need("  mark  tom  ", "  travis  "), "mark tom travis")
assert.strictEqual(api.need("  mark  tom  ", "tom"), "mark tom")
